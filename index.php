...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `iwt_contact`.`contact` (`name`, `age`, `gender`, `email`, `phone`, `address`) VALUES ('$name', '$age', '$gender', '$email', '$phone', '$address');";
...
<body>
    ...
    <div class="container">
        ...
        <p>Please fill the details correctly</p>
        <?php
        if($insert == true){
